...
- The delusion-gap weights (`wSignal`, `wSocial`, `wIdentity`, `revisionThreshold`) operationalize Coltheart/Kunda machinery but their defaults (0.4/0.4/0.2/0.5) are starting points — expected to be tuned against eval scenarios, not validated.
