...
- The meaning-made gate (`divergenceFromLog < 0.33`, world-evaluator.ts:643) is the tightest threshold the calibration measured — 1.2% under the gate was the closest any sample came (healthy arc, cadence 1, a pre-flip continue review) and 7% was the tightest margin on a flip review that actually consulted the gate (world-briefly-wrong) — but it sits outside the #96 sweep matrix and stays untuned — tracked by [issue #106](https://github.com/caiotheodoro/perfectman/issues/106) (ADR-0011 D-28).
