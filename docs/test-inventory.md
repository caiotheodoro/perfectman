...
Generated: 2026-08-21T16:39:39.016Z — audited 76 files, 700 `it`/`test` blocks (some it.each expand further at runtime).
...
| engine | 21 | 246 | —
| eval | 4 | 33 | —
| server | 46 | 362 | console(1), async-pause(1)
| shared | 5 | 59 | —

**Total: 76 files, 700 it/test blocks; 2 files flagged.**
...
| packages/server/src/agent/__tests__/intent-parser.test.ts | integration | 12 | 
| packages/server/src/agent/__tests__/persona-loader.test.ts | integration | 7 | 
| packages/server/src/agent/__tests__/prompt-builder.test.ts | integration | 12 | 
...
| packages/server/src/llm/__tests__/ollama-provider.test.ts | integration | 7 | 
...
| packages/server/src/simulation/__tests__/simulation-lifecycle.test.ts | integration | 7 | 
| packages/server/src/simulation/__tests__/simulation-manager.test.ts | integration | 1 | 
