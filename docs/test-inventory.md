...
Generated: 2026-08-23T20:44:59.729Z — audited 90 files, 827 `it`/`test` blocks (some it.each expand further at runtime).
...
| engine | 22 | 259 | —
| eval | 12 | 85 | —
| server | 49 | 410 | console(1), async-pause(1)
| shared | 7 | 73 | —

**Total: 90 files, 827 it/test blocks; 2 files flagged.**
...
| packages/server/src/agent/__tests__/agent-runtime.test.ts | integration | 9 | 
