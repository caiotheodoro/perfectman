...
export class PromptBuilder {
  /**
   * Builds an 8-section prompt for the LLM.
   * System Prompt contains persona identity, voice guidelines, relationship biases, and output contracts.
   * User Prompt contains recent chat context, subjective emotions, pressures, memories, and available actions.
   */
  static build(
