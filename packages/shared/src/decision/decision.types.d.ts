...
export type NoOpReason = "noticed_but_ignored" | "typing_cancelled" | "delayed_intention" | "silent_treatment" | "stored_memory_only" | "watched_private_channel_instead" | "waited_for_someone_else" | "pretended_not_to_care" | "felt_too_uncertain";
