...
const GOULART_SOCIAL_SENSITIVITIES = {
    jealousy: 0.6,
    envy: 0.5,
...
// when triggered.
const BRUNO_SOCIAL_SENSITIVITIES = {
...
// escalates.
const CAIO_SOCIAL_SENSITIVITIES = {
    jealousy: 0.3,
    envy: 0.2,
    humiliation: 0.9,
    pride: 0.8,
...
const MARIANA_SOCIAL_SENSITIVITIES = {
    jealousy: 0.8,
    envy: 0.7,
    humiliation: 1.2,
    pride: 2.0,
...
const LEO_SOCIAL_SENSITIVITIES = {
    jealousy: 0.5,
    envy: 0.4,
    humiliation: 0.8,
    pride: 1.0,
...
export const ALL_PERSONAS = [GOULART, BRUNO, CAIO, MARIANA, LEO];
